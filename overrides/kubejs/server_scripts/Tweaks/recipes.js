...
ServerEvents.recipes(allthemods => {
    allthemods.shaped(
        `8x minecraft:item_frame[entity_data={Invisible:1b,id:"minecraft:item_frame"},custom_name='"Невидимая рамка"']`,
        [
            'iii',
            'ipi', 
            'iii'
    ...
    allthemods.shaped(
        `8x minecraft:glow_item_frame[entity_data={Invisible:1b,id:"minecraft:item_frame"},custom_name='"Невидимая светящаяся рамка"']`,
        [
            'iii',
            'ipi', 
            'iii'
