...
# Улучшения МЭ-устройств

Эти улучшения заменяют обычные МЭ-устройства расширенными версиями без разрушения блоков.
...
Нажмите улучшением правой кнопкой мыши по соответствующему устройству, крадучись, чтобы превратить его в расширенную
версию. Все настройки и содержимое сохранятся.

<GameScene zoom="6" background="transparent">
  <ImportStructure src="../structure/upgrade_show_1.snbt"></ImportStructure>
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        Это обычные поставщики шаблонов. Их можно улучшить при помощи улучшения поставщика шаблонов.
...
<GameScene zoom="6" background="transparent">
  ...
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        Расширенные поставщики сохраняют все настройки и хранилища шаблонов исходных поставщиков.
  </BoxAnnotation>
</GameScene>
