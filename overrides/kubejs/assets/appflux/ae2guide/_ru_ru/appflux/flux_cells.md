...
ME-ячейки хранения FE — основной способ хранения энергии в Applied Flux. Их ёмкость измеряется в байтах, как и у
[ячеек хранения предметов и жидкостей](ae2:items-blocks-machines/storage_cells.md).

# Ёмкость ячеек

По умолчанию каждый байт вмещает 1 048 576 FE. Это значение можно изменить в конфигурации Applied Flux.

| Ячейка                                 | Ёмкость в FE (по умолчанию)   |
|----------------------------------------|------------------------------:|
