...
Краскошарики используются в <ItemLink id="color_applicator" /> для окрашивания поддерживающих это блоков:
[кабелей](cables.md), шерсти, терракоты, стекла и бетона. Ими также можно стрелять из <ItemLink id="matter_cannon" />,
оставляя небольшие пятна краски.
...
Они действуют как обычные краскошарики, но выпущенные из <ItemLink id="matter_cannon" /> пятна излучают свет.
Получается что-то вроде сигнального пистолета.

## Рецепты

8 краскошариков вокруг светокаменной пыли.
